...
import { MESSAGE_QUERY_KEY, SESSION_QUERY_KEY, SESSION_TIMEOUT, sessionKey } from "@/app/config";
...
type TimeoutSession = ExtendedSession & {
...
export default function useSession() {
    ...
    const fiveMinutesAgo = new Date(currentDatetime.getTime() - SESSION_TIMEOUT * 60 * 1000);
